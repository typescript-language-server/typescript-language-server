...
[Language Server Protocol](https://github.com/Microsoft/language-server-protocol) implementation for TypeScript wrapping `tsserver`. You must install it first via `$ npm install -g typescript`.
